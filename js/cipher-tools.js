...
/**
 * This function counts the amount of each letter present in a string and returns an associative array.
...
/**
 * updates data from an associative array onto a chart
 * @param inputArray
 * @param chart
 */
...
/**
 * use this function to align the two text charts together by applying a bias to make the cipher frequency move
 * @param plainChartArray
 * @param cipherChartArray
 * @param bias
 */
...
/**
 * Adds data with a label to a chart
 * @param chart
 * @param label
 * @param data
 */
...
/**
 * Removes all elements of the chart (assumes 26 letters in the alphabet).
 * @param chart
 */
...
/**
 * Removes the last element of the chart
 * @param chart
 */
...
/**
 * Adds data to the mixed table chaRT, IF THIS IS THE CIPHER DATA, update the alphabet
 * @param chart
 * @param label
 * @param index
 * @param data
...
/**
 * This function takes an array and cycles it based on the number of cycles
 * @param arr
 * @param cycles
 * @returns {*}
 */
...
/**
 * Processes the slider input generated by sliding the frequency in order to align them
 */
function decaeserBy() {
